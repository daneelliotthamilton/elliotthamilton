class Admin::PracticeAreasController < AdminController
    ...
    # POST /practice_areas or /practice_areas.json
    def create
      @practice_area = PracticeArea.new(practice_area_params)
  
      respond_to do |format|
        if @practice_area.save
          format.html { redirect_to admin_practice_area_url(@practice_area), notice: "Practice area was successfully created." }
    ...
    # PATCH/PUT /practice_areas/1 or /practice_areas/1.json
    def update
      respond_to do |format|
        if @practice_area.update(practice_area_params)
          format.html { redirect_to admin_practice_area_url(@practice_area), notice: "Practice area was successfully updated." }
    ...
    # DELETE /practice_areas/1 or /practice_areas/1.json
    def destroy
      @practice_area.destroy
  
      respond_to do |format|
        format.html { redirect_to admin_practice_areas_url, notice: "Practice area was successfully destroyed." }
