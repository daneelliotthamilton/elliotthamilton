...
ActiveRecord::Schema.define(version: 2025_02_17_143155) do
  ...
  create_table "practice_areas", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["slug"], name: "index_practice_areas_on_slug"
  end
  ...
  create_table "support_feedbacks", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "subject"
    t.text "message"
  ...
  add_foreign_key "pages_tags", "pages"
