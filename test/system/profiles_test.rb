...
class ProfilesTest < ApplicationSystemTestCase
  ...
  test "should create profile" do
    ...
    fill_in "Bar admissions", with: @profile.bar_admissions
    fill_in "Biogragraphy", with: @profile.biogragraphy
    fill_in "Education", with: @profile.education
    fill_in "Email", with: @profile.email
    fill_in "Expertise", with: @profile.expertise
    fill_in "Title", with: @profile.title
    fill_in "Vcard", with: @profile.vcard
